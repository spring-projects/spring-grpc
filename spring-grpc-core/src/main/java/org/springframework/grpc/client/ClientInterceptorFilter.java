...
public interface ClientInterceptorFilter {
	 ...
	 * @return {@code true} if the interceptor should be included; {@code false} otherwise
	 */
	boolean shouldInclude(ClientInterceptor interceptor, GrpcChannelFactory channelFactory);
