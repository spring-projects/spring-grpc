...
NOTE: The examples below assume you are running inside a Spring Boot application and therefore use `spring-boot-dependencies` either explicitly or implicitly by using the Spring Boot starter parent or Gradle plugin.
